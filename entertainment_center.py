...
friends = media.TvShow("Friends", "8.9",
						...
						"http://www.gstatic.com/tv/thumb/tvbanners/183931/p183931_b_v8_ac.jpg",  # NOQA
						"https://youtu.be/Yp0kth7-zsM",
						"10", "NBC")

friends.tv_episodes = ["The One After Joey and Rachel Kiss",
...
game_of_thrones.tv_episodes = ["Dragonstone", "Stormborn", "Queen of Justice",
...
the_big_bang.tv_episodes = ["Pilot", "The Big Bran Hypothesis",
...
videos = [interstellar, inception, fight_club, spirited_away, shutter_island,
